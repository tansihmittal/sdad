            ...
            <tbody>
                <?php foreach($plans as $plan): ?>
                    <tr>
                        ...
                        <td>
                            <span class="badge text-primary border border-primary"><?php echo $plan->numurls == "0" ? "Unlimited" : $plan->numurls ?> <?php ee('links') ?></span>
                        ...
                        <td>
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo route('admin.plans.toggle', [$plan->id]) ?>"> <?php echo $plan->status == '1' ? '<i data-feather="toggle-right"></i> '.e('Disable') : '<i data-feather="toggle-left"></i> '.e('Enable') ?></a></li>
