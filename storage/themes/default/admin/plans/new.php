                        ...
                        <div class="col-md-4 mb-3">
                            <div class="border rounded-3 p-3 h-100">
                                ...
                                <?php if(isset($feature['custom'])): ?>
                                    <div class="form-group mb-4 d-none">
                                        <label for="permission-<?php echo $slug ?>-custom" class="form-label fw-bold"><?php ee('Permission') ?></label>
                                        <input type="text" class="form-control p-2" name="permission[<?php echo $slug ?>][custom]" id="permission-<?php echo $slug ?>-custom">
                                        <p class="form-text mt-2 fs-5"><?php echo $feature['custom'] ?></p>
                                    </div>
                                <?php endif ?>  
                            </div>
                        </div>
