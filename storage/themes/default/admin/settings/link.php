        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="post" action="<?php echo route('admin.settings.save') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-4">
					    <label for="schemes" class="form-label fw-bold"><?php ee('Allowed Schemes') ?></label>
                    ...
                    <hr>
                    <div class="form-group">
                        <label for="" class="form-label fw-bold"><?php ee('Anonymous Links Stats') ?></label>
                    ...
                    <div class="form-group">
                        <label for="" class="form-label fw-bold"><?php ee('Manual Link Approval') ?></label>
                        <div class="form-check form-switch">
                    ...
                    <div class="form-group">
                        <label for="" class="form-label fw-bold"><?php ee('Media Gateway') ?></label>
                        <div class="form-check form-switch">
                    ...
                    <div class="form-group">
                        <label for="" class="form-label fw-bold"><?php ee('Geo Targeting') ?></label>
                        <div class="form-check form-switch">
                    ...
                    <div class="form-group">
                        <label for="" class="form-label fw-bold"><?php ee('Device Targeting') ?></label>
                        <div class="form-check form-switch">
