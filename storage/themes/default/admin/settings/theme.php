            ...
            <div class="card-body">
                <form method="post" action="<?php echo route('admin.settings.save') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="user_history" class="form-label fw-bold"><?php ee('Anonymous User History') ?></label>
                        ...
                        <p class="form-text"><?php ee('If enabled, anonymous users can view their personal history of URLs on the home page.').' '.ee('Please note that some themes might not support this feature') ?></p>
                    </div>   
                    <div class="form-group">
                        <label for="public_dir" class="form-label fw-bold"><?php ee('Public URL List') ?></label>
                        <div class="form-check form-switch">
                        ...
                        <p class="form-text"><?php ee('Enabling this will display a list of new public URLs on the home page. Only the last 25 URLs will be shown there. If you enable this, some parts of the homepage will be removed.').' '.ee('Please note that some themes might not support this feature') ?></p>
                    </div> 
                    <div class="form-group">
                        <label for="homepage_stats" class="form-label fw-bold"><?php ee('Stats on Homepage') ?></label>
                        <div class="form-check form-switch">
