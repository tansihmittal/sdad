            ...
            <div class="card-body">
                <form method="post" action="<?php echo route('admin.settings.save') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <label for="adult" class="form-label fw-bold"><?php ee('Blacklisting URLs') ?></label>
                    ...
                    <hr>
                    <div class="form-group mb-4">
					    <label for="phish_username" class="form-label fw-bold"><?php ee('Phishtank Username') ?></label>
                    ...
                    <div class="form-group mb-4">
					    <label for="phish_api" class="form-label fw-bold"><?php ee('Phishtank API') ?></label>
