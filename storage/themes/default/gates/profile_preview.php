            ...
            <?php if(!isset($profiledata['style']['layout']) || $profiledata['style']['layout'] == 'layout1'): ?>                
                ...
                <h3>
                    ...
                    <?php if($user->verified): ?>
                        <span class="text-success fw-bold ml-2 bg-white rounded-circle checkmark" data-toggle="tooltip" data-placement="top" title="<?php ee('Verified Account') ?>"><i class="fa fa-check-circle"></i></span>
                    <?php endif ?>
                </h3>
                ...
                <div class="layout3">
                    <div class="d-block p-5 rounded" style="background-color: <?php echo $profiledata['style']['bg'] ?>;<?php if(isset($profiledata['layoutbanner']) && $profiledata['layoutbanner']) echo 'background-image:url(\''.uploads($profiledata['layoutbanner'], 'profile').'\');background-size:cover;'; ?>">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-4 text-left text-start">
                                <h3>
                                    <span><?php echo $profile->name ?></span>
                                    <?php if($user->verified): ?>
                                        <span class="text-success fw-bold ml-2 bg-white rounded-circle checkmark text-center" data-toggle="tooltip" data-placement="top" title="<?php ee('Verified Account') ?>"><i class="fa fa-check-circle"></i></span>
                                    <?php endif ?>
                                </h3>
                                <?php if(isset($profiledata['tagline'])): ?>
                                    <p><?php echo $profiledata['tagline'] ?></p>
                ...
                <?php foreach($profiledata['links'] as $id => $value): ?>
                    <div class="item mb-3">
                        ...
                        <?php if($value['type'] == "newsletter"): ?>
                            <a href="#" data-target="#N<?php echo $id ?>" data-toggle="collapse" role="button" class="btn btn-block d-block p-3 btn-custom position-relative">
                        ...
                        <?php if($value['type'] == "contact"): ?>
                            <a href="#" data-target="#C<?php echo $id ?>" data-toggle="collapse" role="button" class="btn btn-block d-block p-3 btn-custom position-relative">
                                <span class="align-top"><?php echo $value['text'] ?></span>
                                <i class="fa fa-chevron-down position-absolute right-0 mr-3"></i>
                            </a>
                        ...
                        <?php if($value['type'] == "product"): ?>
                            <a href="#" target="_blank" class="d-block btn-custom rounded p-2 mt-2 text-start text-left" rel="nofollow">
                                <div class="d-flex align-items-center">
