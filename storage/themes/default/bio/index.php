<div class="d-flex mb-5">
	<div>
		<h1 class="h3 mb-0"><?php ee('Bio Pages') ?></h1>
	</div>
	<div class="ms-auto">
...
<div class="row">
    <div class="col-sm-4">
        <div class="card shadow-sm">
            <div class="card-body">
                <h5 class="fw-bold mb-4"><?php ee('Bio Pages') ?></h5>
    ...
    <div class="col-sm-4">
        <div class="card shadow-sm">
            <div class="card-body">
                <h5 class="fw-bold mb-4"><?php ee('Views') ?></h5>
                <span class="h1"><?php echo $views ?></span> <span class="text-success"><?php ee('views') ?></span>
            </div>
        </div>
    </div>
</div>
