        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action rounded active" href="#plugin" data-bs-toggle="collapse"><?php echo e("WordPress Plugin") ?></a>
                    <a class="list-group-item list-group-item-action rounded" href="#function" data-bs-toggle="collapse"><?php echo e("WordPress Function") ?></a>
                </div>
            </div>
        </div>
    </div>
