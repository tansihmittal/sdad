    ...
    <div class="container">
        <div class="card border-0 shadow-sm mb-5 mx-lg-5">
            <div class="card-body text-center py-10 px-5">
                <h1 class="display-2 fw-bold"><?php ee('Earn {p} commission on affiliate sales', null, ['p' => "<u><strong class=\"gradient-primary clip-text\">{$affiliate->rate}%</strong></u>"]) ?></h1>
                <p class="my-5 lead"><?php ee('Refer customers to us and we will reward you a {p}% commission on all qualifying sales made on our website. Anyone can join the affiliate program.', null, ['p' => $affiliate->rate]) ?></p>
