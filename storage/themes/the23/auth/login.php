<a href="<?php echo route('home') ?>" class="position-absolute top-0 start-0 text-dark text-decoration-none d-block ps-4 pt-4">
    <?php if(config('logo')): ?>
        <?php if(request()->cookie('darkmode') || themeSettings::isDark() ? ' data-theme="dark"' : ''): ?>
                            ...
                            <?php if(config('fb_connect') || config('tw_connect') || config('gl_connect')): ?>
                                ...
                                <div class="d-flex justify-content-center mb-4">
                                    ...
                                    <?php if(config('tw_connect')): ?>
                                        <a href="<?php echo route('login.twitter') ?>" class="btn btn-block btn-icon border rounded-circle" title="<?php echo e("Sign in with") ?> Twitter" data-toggle="tooltip">
                                            <img src="<?php echo assets('images/twitter.svg') ?>" alt="<?php echo e("Sign in with") ?> Twitter">
                                        </a>
                                    <?php endif ?>
