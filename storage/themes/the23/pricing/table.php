<div class="card border-0 rounded-lg shadow-sm text-center p-4 py-5 table-responsive mt-5">
		...
		<tbody>
			...
			<tr>
				...
				<td class="py-3 fw-bold">
					<?php echo $plan['urls'] == '0' ? '<i class="align-middle fa fa-infinity gradient-primary clip-text"></i>' : number_format($plan['urls']) ?>
				</td>
				<?php endforeach ?>
			</tr>
			<tr>
