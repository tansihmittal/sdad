            ...
            <div class="card mb-5 border-0 shadow-sm text-center mx-1 position-relative">
                ...
                <div class="card-body rounded-bottom p-4 position-relative">
                    <ul class="list-unstyled mb-4 text-start text-dark">
                        <li class="mb-3"><span class="border-bottom" data-bs-toggle="tooltip" title="<?php ee('Number of short links allowed.') ?>"><?php ee("Short Links") ?></span><span class="float-end fw-bold"><?php echo $plan["urls"] == "0" ? '<i class="fa fa-infinity"></i>' : number_format($plan["urls"]) ?></span></li>
