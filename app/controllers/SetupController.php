...
class Setup {
    ...
    public function stepvalidate($request){
        ...
        echo '<h2>2.0 Validate Purchase Code | <a href="https://cutt.ly/PLFZenO" target="_blank">NULLED :: Web Community</a></h2>
        '.message().'
        <p>
